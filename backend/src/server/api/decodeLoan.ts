import decode_loan from "../../decoder/decode_loan.js";
import { BadRequestError } from "../errors.js";

export default async function decodeLoan(url:URL){
    ...
    console.log('decode_loan:',mutable_data_hex,immutable_data_hex,":", result);
}