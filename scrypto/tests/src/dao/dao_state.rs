...
impl DaoState {
    ...
    pub fn assert_variables_are(&self, voter_card_id: u64, proposal_id: u64, total_voting_power: Decimal, vote_period: i64, vote_validity_threshold: Decimal) {
    ...
    pub fn assert_issuer_state(&self, reserves: &HashMap<String, Decimal>,
                               lenders: &HashMap<String, LenderState>,
                               loan_id: u64,
                               flash_mint_id: u64) {

        self.issuer_state.assert_state_is(reserves, lenders, loan_id, flash_mint_id);
    }
