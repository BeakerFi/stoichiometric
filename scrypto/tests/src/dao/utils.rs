...
use crate::utils::{ADMIN_BADGE_NAME, POSITION_NAME, STABLECOIN_NAME, VOTER_CARD_NAME, run_command};
...
pub fn lock_stablecoins(test_env: &mut TestEnvironment, amount_stable: Decimal, voter_card_id: Option<String>) -> ManifestCall {
...
pub fn lock_positions(test_env: &mut TestEnvironment, position_ids: Vec<String>, voter_card_id: Option<String>) -> ManifestCall {
    let mut env_args = Vec::new();
