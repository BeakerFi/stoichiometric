...
async function amountToLiquidate(collateral_amount: number, collateral_price: number, amount_lent: number, liquidation_threshold: number, liquidation_penalty: number, daily_interest_rate: number, loan_date: number) {
